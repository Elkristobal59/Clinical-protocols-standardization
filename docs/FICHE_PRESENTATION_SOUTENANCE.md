...
3.  **Modèles SLM :** Fine-tuning d'un très petit modèle (Small Language Model, type Qwen-0.5B) ultra-spécialisé pour remplacer définitivement notre modèle 7B d'inférence, réduisant drastiquement les coûts (Edge AI sur petits serveurs locaux).
